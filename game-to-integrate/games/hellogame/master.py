...
from playpen.playpengame.playpengame import GameMaster, GameBenchmark, Player, DialogueGameMaster
...
class HelloGame(DialogueGameMaster):
    ...
    def _on_setup(self, **game_instance):
        ...
        self.greeter = Greeter(self.player_agents[0])
...
class HelloGameBenchmark(GameBenchmark):
    ...
    def create_game_master(self, experiment: Dict, player_agents: List[Agent]) -> GameMaster:
        return HelloGame(experiment, player_agents)
