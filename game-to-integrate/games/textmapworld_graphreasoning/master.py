...
import numpy as np
import ast
from playpen.playpengame.playpengame import GameMaster, GameBenchmark, Player, DialogueGameMaster, GameScorer
from playpen.playpengame.metrics import METRIC_ABORTED, METRIC_SUCCESS, METRIC_LOSE, BENCH_SCORE
from playpen.games.textmapworld_graphreasoning.utils import loop_identification, get_directions, string_available_directions, have_common_element, get_nextnode_label, calculate_similarity, create_graph
...
class Graphreasoning(DialogueGameMaster):
    ...
    def _on_setup(self, **game_instance):
        ...
        self.guesser = PathGuesser(self.player_agents[0])
...
class GraphGameBenchmark(GameBenchmark):
    ...
    def create_game_master(self, experiment: Dict, player_agents: List[Agent]) -> GameMaster:
        return Graphreasoning(experiment, player_agents)
