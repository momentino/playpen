...
import playpen.games.mm_mapworld_graphs.utils as utils

from playpen.playpengame.playpengame import GameMaster, GameBenchmark, DialogueGameMaster, GameScorer, Player
...
class MmMapWorldGraphs(DialogueGameMaster):
    ...
    def _on_setup(self, **game_instance):
        ...
        self.walker = PathWalker(self.player_agents[0])
...
class MmMapWorldGraphsBenchmark(GameBenchmark):
    ...
    def create_game_master(self,
        ...
        return MmMapWorldGraphs(experiment, player_agents)
