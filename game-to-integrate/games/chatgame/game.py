...
class ChatGame:
    ...
    def __init__(self, game_instance: Dict, player_agents: Tuple[Agent]):
        ...
        self.questioner: Human = Human(player_agents[0])
        self.answerer: Answerer = Answerer(player_agents[1], max_turns=self.max_turns)
