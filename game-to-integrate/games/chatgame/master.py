...
from playpen.games.chatgame.game import ChatGame
...
class Chat(GameMaster, APIChatBot):
    ...
    def __init__(self,
        ...
        GameMaster.__init__(self, GAME_NAME, experiment, player_agents)
    ...
    def _on_setup(self, **game_instance):
        ...
        self.game = ChatGame(self.game_instance, self.player_agents)
...
class ChatGameBenchmark(GameBenchmark):
    ...
    def create_game_master(self, experiment: Dict, player_agents: bool) -> GameMaster:
        return Chat(experiment, player_agents)
