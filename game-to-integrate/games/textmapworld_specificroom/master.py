...
from playpen.games.textmapworld_specificroom.utils import loop_identification, get_directions, string_available_directions, have_common_element, get_nextnode_label
...
class GraphGameBenchmark(GameBenchmark):
    ...
    def create_game_master(self, experiment: Dict, player_agents: List[Agent]) -> GameMaster:
        return textmapworld_specificroom(experiment, player_agents)
