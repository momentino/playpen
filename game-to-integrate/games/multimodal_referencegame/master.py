...
from playpen.games.multimodal_referencegame.game import MultimodalReferenceGame
import re
...
class MultimodalReferenceGameMaster(GameMaster):
    ...
    def setup(self, **game_instance):
        ...
        self.game = MultimodalReferenceGame(self.game_instance, self.player_agents)
...
class MultimodalReferenceGameBenchmark(GameBenchmark):
    ...
    def create_game_master(self, experiment: Dict, player_agents: List[Agent]) -> GameMaster:
        return MultimodalReferenceGameMaster(experiment, player_agents)
