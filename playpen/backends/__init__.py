...
playpen_module_root = project_root / "playpen"
...
def read_model_specs(model_string: str):
    try:
...
def load_custom_model_registry(_model_registry_path: str = None, is_optional=True):
    if not _model_registry_path:
        _model_registry_path = os.path.join(project_root, "playpen", "backends", "model_registry_custom.json")
...
def load_model_registry(_model_registry_path: str = None, is_mandatory=True):
    if not _model_registry_path:
        _model_registry_path = os.path.join(project_root, "playpen", "backends", "model_registry.json")
...
def _register_backend(backend_name: str):
    ...
    """
    backends_root = os.path.join(playpen_module_root, "backends")
