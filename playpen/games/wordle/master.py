...
from playpen.games.wordle.utils.compute_metrics import ComputeMetrics
from playpen.games.wordle.utils.guessvalidator import GuessValidator
...
class WordleGameMaster(GameMaster):
    def __init__(self, game_name: str, experiment: Dict, player_agents: List[Agent]):
        ...
        self.player_model_names = [
            player_model.get_name() for player_model in player_agents
        ]
    ...
    def setup(self, game_id, target_word, target_word_clue, target_word_difficulty):
        ...
        """if self.config["use_clue"]:
            if isinstance(self.player_agents[0], HumanModel):
        ...
        game_config["models"] = self.player_agents
