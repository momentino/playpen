...
from playpen.playpengame import GameInstanceGenerator
...
class ReferenceGameInstanceGenerator(GameInstanceGenerator):
    ...
    def on_generate(self):
        ...
        player_a_prompt_header = self.load_template(
            f"resources/initial_prompts/player_a_prompt_header_zero_shot.template")
        player_b_prompt_header = self.load_template(
            f"resources/initial_prompts/player_b_prompt_header_zero_shot.template")
