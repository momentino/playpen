...
[here](../playpen/clemgame/clemgame.py) for a base scoring procedure.
...
`clemgame/metrics.py` [here](../playpen/clemgame/metrics.py) (see the [paper](https://doi.org/10.48550/arXiv.2305.13455)'s 
